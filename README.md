...
Para executar a solução:<br/>
1- Ao lado direito no site, clique na opção "Download Zip".<br/>
2- O Download da pasta compactada do projeto será feito em sua máquina.<br/>
3- Descompacte a pasta.<br/>

Caso queira apenas executar a solução:<br/>
...
Case queira abrir o código fonte:<br/>
